...
object IndiaLocations {
    // Map<State, Map<District, List<City>>>
    val data: LinkedHashMap<String, LinkedHashMap<String, List<String>>> = linkedMapOf(
        "Andhra Pradesh" to linkedMapOf(
        ...
        "Arunachal Pradesh" to linkedMapOf(
        ...
        "Himachal Pradesh" to linkedMapOf(
            "Bilaspur" to listOf("Bilaspur", "Ghumarwin", "Naina Devi"),
        ...
        "Andaman and Nicobar Islands" to linkedMapOf(
        ...
        "Chandigarh" to linkedMapOf(
            "Chandigarh" to listOf("Chandigarh", "Manimajra", "Daria")
        ),
        "Dadra and Nagar Haveli and Daman and Diu" to linkedMapOf(
        ...
        "Jammu and Kashmir" to linkedMapOf(
    ...
    fun getStates(): List<String> = data.keys.sorted()
    fun getDistricts(state: String): List<String> = data[state]?.keys?.sorted() ?: emptyList()
    fun getCities(state: String, district: String): List<String> = data[state]?.get(district) ?: emptyList()
}
